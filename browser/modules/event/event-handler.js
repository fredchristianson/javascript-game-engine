...
import { FUNCTION, STRING, UTIL } from '../helpers.js';
...
export class EventHandler {
    ...
    get PassiveListener() { return this._passive; }
    get Capture() { return this._capture; }
    get ListenOnce() { return this._listenOnce; }
    set PassiveListener(enable) { this._passive = enable; }
    set Capture(enable) { this._capture = enable; }
    set ListenOnce(enable) { this._listenOnce = enable; }
    ...
    get Selector() { return this._selector ?? this._targetElement; }
    ...
    processEvent(event) {
        ...
        for (let handlerFunction of this._handlerFunctions) {
